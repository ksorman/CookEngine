...
void GLTracer_glTransformFeedbackBufferRange(GLuint xfb, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
	printf("glTransformFeedbackBufferRange(" "%u, %u, %u, %" PRId64", %lli)\n", xfb, index, buffer, offset, size);
...
void GLTracer_glNamedBufferStorage(GLuint buffer, GLsizeiptr size, const void* data, GLbitfield flags)
{
	printf("glNamedBufferStorage(" "%u, %lli, %p, %u)\n", buffer, size, data, (unsigned int)(flags));
...
{
	printf("glNamedBufferData(" "%u, %lli, %p, %s)\n", buffer, size, data, E2S(usage));
	apiHook.glNamedBufferData(buffer, size, data, usage);
	assert(apiHook.glGetError() == GL_NO_ERROR);
}

void GLTracer_glNamedBufferSubData(GLuint buffer, GLintptr offset, GLsizeiptr size, const void* data)
{
	printf("glNamedBufferSubData(" "%u, %" PRId64", %lli, %p)\n", buffer, offset, size, data);
	apiHook.glNamedBufferSubData(buffer, offset, size, data);
	assert(apiHook.glGetError() == GL_NO_ERROR);
}

void GLTracer_glCopyNamedBufferSubData(GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size)
{
	printf("glCopyNamedBufferSubData(" "%u, %u, %" PRId64", %" PRId64", %lli)\n", readBuffer, writeBuffer, readOffset, writeOffset, size);
...
void GLTracer_glClearNamedBufferSubData(GLuint buffer, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const void* data)
{
	printf("glClearNamedBufferSubData(" "%u, %s, %" PRId64", %lli, %s, %s, %p)\n", buffer, E2S(internalformat), offset, size, E2S(format), E2S(type), data);
...
void* GLTracer_glMapNamedBufferRange(GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access)
{
	printf("glMapNamedBufferRange(" "%u, %" PRId64", %lli, %u)\n", buffer, offset, length, (unsigned int)(access));
...
{
	printf("glFlushMappedNamedBufferRange(" "%u, %" PRId64", %lli)\n", buffer, offset, length);
...
{
	printf("glGetNamedBufferSubData(" "%u, %" PRId64", %lli, %p)\n", buffer, offset, size, data);
...
void GLTracer_glClearNamedFramebufferfi(GLuint framebuffer, GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil)
{
...
void GLTracer_glTextureBufferRange(GLuint texture, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
	printf("glTextureBufferRange(" "%u, %s, %u, %" PRId64", %lli)\n", texture, E2S(internalformat), buffer, offset, size);
...
{
	printf("GLTracer_glPolygonOffset(" "%f, %f)\n", factor, units);
